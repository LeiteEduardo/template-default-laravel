    ...
    <div class="col-xl-4 col-md-6 col-12">
        <div class="card card-congratulation-medal">
            <div class="card-body">
                ...
                <img src="{{ url('assets/images/illustration/badge.svg') }}" class="congratulation-medal" alt="Medal Pic" />
            </div>
        </div>
    </div>
    <!--/ Medal Card -->
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar rounded">
                                            <div class="avatar-content">
                                                <img src="{{ url('assets/images/icons/toolbox.svg') }}" alt="Toolbar svg" />
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar rounded">
                                            <div class="avatar-content">
                                                <img src="{{ url('assets/images/icons/parachute.svg') }}" alt="Parachute svg" />
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar rounded">
                                            <div class="avatar-content">
                                                <img src="{{ url('assets/images/icons/brush.svg') }}" alt="Brush svg" />
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar rounded">
                                            <div class="avatar-content">
                                                <img src="{{ url('assets/images/icons/star.svg') }}" alt="Star svg" />
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar rounded">
                                            <div class="avatar-content">
                                                <img src="{{ url('assets/images/icons/book.svg') }}" alt="Book svg" />
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar rounded">
                                            <div class="avatar-content">
                                                <img src="{{ url('assets/images/icons/rocket.svg') }}" alt="Rocket svg" />
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar rounded">
                                            <div class="avatar-content">
                                                <img src="{{ url('assets/images/icons/speaker.svg') }}" alt="Speaker svg" />
                                            </div>
                                        </div>
                                        <div>
    ...
    <div class="col-lg-4 col-md-6 col-12">
        <div class="card card-developer-meetup">
            <div class="meetup-img-wrapper rounded-top text-center">
                <img src="{{ url('assets/images/illustration/email.svg') }}" alt="Meeting Pic" height="170" />
            </div>
            <div class="card-body">
        ...
        <div class="card card-browser-states">
            ...
            <div class="card-body">
                <div class="browser-states">
                    <div class="d-flex">
                        <img src="{{ url('assets/images/icons/google-chrome.png') }}" class="rounded me-1" height="30" alt="Google Chrome" />
                ...
                <div class="browser-states">
                    <div class="d-flex">
                        <img src="{{ url('assets/images/icons/mozila-firefox.png') }}" class="rounded me-1" height="30" alt="Mozila Firefox" />
                ...
                <div class="browser-states">
                    <div class="d-flex">
                        <img src="{{ url('assets/images/icons/apple-safari.png') }}" class="rounded me-1" height="30" alt="Apple Safari" />
                ...
                <div class="browser-states">
                    <div class="d-flex">
                        <img src="{{ url('assets/images/icons/internet-explorer.png') }}" class="rounded me-1" height="30" alt="Internet Explorer" />
                ...
                <div class="browser-states">
                    <div class="d-flex">
                        <img src="{{ url('assets/images/icons/opera.png') }}" class="rounded me-1" height="30" alt="Opera Mini" />
